...
# =============== SONG PLAYER ===============
    ...
    # ✅ UPDATED KARAOKE TEMPLATE - VOICE + ACCOMPANIMENT ONLY (NO ORIGINAL IN RECORDING)
    karaoke_template = """
<!doctype html>
<html>
<head>
...
button { 
    background: linear-gradient(135deg, #ff0066); 
    border: none; 
    color: white; 
    padding: 8px 20px; 
    border-radius: 25px; 
...
/* ================== RECORD - VOICE + ACCOMPANIMENT ONLY (NO ORIGINAL IN RECORDING) ================== */
